...
(function () {
  ...
  /***************************************************************************
     Follower list data source #1:
       GET https://plus.google.com/_/socialgraph/lookup/followers/?m=1000000
       while logged in to Google+.
  ...
  /***************************************************************************
     Follower list data source #2:
       GET 'https://plus.google.com/_/socialgraph/lookup/incoming/?o=%5Bnull%2Cnull%2C%22123456789012345678901%22%5D&n=1000000&rt=j
  ...
  /***************************************************************************
     Follower list data source #3:
       GET https://plus.google.com/people/haveyou?hl=en
       while logged in to Google+.
  ...
  function getFollowersDataSource3(followerSet, callback) {
    ...
    Request({
      url: 'https://plus.google.com/people/haveyou',
      content: {hl: 'en'},
      overrideMimeType: 'text/plain; charset=utf-8',
      onComplete: function (response) {
